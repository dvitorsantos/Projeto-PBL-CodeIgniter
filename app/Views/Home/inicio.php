...
<body class="bg-light text-dark">
    ...
    <div class="container">
        ...
        <div id="conteudo" class="mt-3">
            <div class="row align-items-center">
                <div class="col">
                    <div class="">
                        <h1 class="display-6 text-center mb-3">Text 1</h1>
                    </div>
                    ...
                    <p class="lead">Arcu odio ut sem nulla pharetra diam sit amet nisl. In fermentum posuere urna nec tincidunt praesent. Ultrices eros in cursus turpis. Aliquet nec ullamcorper sit amet risus nullam eget felis eget. Adipiscing bibendum est ultricies integer quis auctor elit sed. Viverra suspendisse potenti nullam ac tortor vitae. Quis hendrerit dolor magna eget. Integer eget aliquet nibh praesent tristique magna sit. Eu sem integer vitae justo eget. Tellus mauris a diam maecenas sed enim ut sem viverra.
                        ...
                        Donec enim diam vulputate ut pharetra. Elit sed vulputate mi sit amet mauris commodo quis. Id porta nibh venenatis cras sed felis. Rhoncus aenean vel elit scelerisque mauris pellentesque pulvinar pellentesque habitant. Fames ac turpis egestas sed tempus. Morbi non arcu risus quis varius. Sed risus pretium quam vulputate dignissim suspendisse in. Ornare suspendisse sed nisi lacus sed. Ante metus dictum at tempor commodo ullamcorper a. Vitae aliquet nec ullamcorper sit amet. Ut venenatis tellus in metus vulputate eu scelerisque felis. Non tellus orci ac auctor augue mauris augue neque.</p>
                </div>
            </div>
